...
def get_demo_fixtures() -> dict:
    """
    Return realistic demo fixtures for development when scraping is unavailable.
    
    Simulates a typical Progol quiniela with Liga MX, European, and 
    ...
    return {
        ...
        "progol": [
            {"match_num": 1, "home": "América", "away": "Guadalajara",
             "league": "Liga MX"},
            {"match_num": 2, "home": "Cruz Azul", "away": "Pumas",
             "league": "Liga MX"},
            {"match_num": 3, "home": "Monterrey", "away": "Tigres",
             "league": "Liga MX"},
            {"match_num": 4, "home": "Toluca", "away": "León",
             "league": "Liga MX"},
            {"match_num": 5, "home": "Atlas", "away": "Santos",
             "league": "Liga MX"},
            {"match_num": 6, "home": "Pachuca", "away": "Puebla",
             "league": "Liga MX"},
            {"match_num": 7, "home": "Necaxa", "away": "Querétaro",
             "league": "Liga MX"},
            {"match_num": 8, "home": "Arsenal", "away": "Liverpool",
             "league": "Premier League"},
            {"match_num": 9, "home": "Barcelona", "away": "Real Madrid",
             "league": "La Liga"},
            {"match_num": 10, "home": "Bayern Munich", "away": "Dortmund",
             "league": "Bundesliga"},
            {"match_num": 11, "home": "Inter", "away": "Milan",
             "league": "Serie A"},
            {"match_num": 12, "home": "PSG", "away": "Marseille",
             "league": "Ligue 1"},
            {"match_num": 13, "home": "Tijuana", "away": "Mazatlán",
             "league": "Liga MX"},
            {"match_num": 14, "home": "Juárez", "away": "San Luis",
             "league": "Liga MX"},
        ],
        "revancha": [
            {"match_num": 15, "home": "Manchester City", "away": "Chelsea",
             "league": "Premier League"},
            {"match_num": 16, "home": "Atlético Madrid", "away": "Sevilla",
             "league": "La Liga"},
            {"match_num": 17, "home": "Juventus", "away": "Roma",
             "league": "Serie A"},
            {"match_num": 18, "home": "Leverkusen", "away": "RB Leipzig",
             "league": "Bundesliga"},
            {"match_num": 19, "home": "Tottenham", "away": "Newcastle",
             "league": "Premier League"},
            {"match_num": 20, "home": "Real Betis", "away": "Valencia",
             "league": "La Liga"},
            {"match_num": 21, "home": "Aston Villa", "away": "West Ham",
             "league": "Premier League"},
        ]
    }
